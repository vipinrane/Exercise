...
{
    public class ServiceCollection<TBaseSmartPart> : ICollection, IEnumerable, IEnumerable<KeyValuePair<Type, object>>
        where TBaseSmartPart : class, ISmartPart
    {
        ...
        internal ServiceCollection ( WorkItem<TBaseSmartPart> root )
        {
            m_root = root;
        ...
        public object AddNew ( Type serviceType )
        {
            ...
            if ( descriptor == null )
            {
                var instance = ObjectFactory<TBaseSmartPart>.CreateObject ( serviceType, m_root );
        ...
        public object AddNew ( Type serviceType, Type registerAs )
        {
            ...
            object instance = ObjectFactory<TBaseSmartPart>.CreateObject ( serviceType, m_root );
        ...
        private void Add ( object instance, string name, Type classType, Type registrationType )
        {
            ...
            lock ( m_syncRoot )
            {
                ...
                if ( name == null ) name = ObjectFactory<TBaseSmartPart>.GenerateServiceName ( registrationType );
                ...
                if ( instance != null )
                {
                    ObjectFactory<TBaseSmartPart>.DoInjections ( instance, m_root );
                }
        ...
        public object Get ( Type serviceType, bool ensureExists )
        {
            lock ( m_syncRoot )
            {
                ...
                {
                    desc.Instance = ObjectFactory<TBaseSmartPart>.CreateObject ( desc.ClassType, m_root );

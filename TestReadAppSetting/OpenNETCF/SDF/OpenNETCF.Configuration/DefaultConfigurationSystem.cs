...
namespace OpenNETCF.Configuration
{
    ...
    class DefaultConfigurationSystem : IConfigurationSystem
    {
        ...
        {
            m_codeBase = OpenNETCF.Reflection.Assembly2.GetEntryAssembly ( ).GetName ( ).CodeBase;
        }

        internal DefaultConfigurationSystem ( string codeBase )
        {
            m_codeBase = codeBase;
        }
        ...
        {
            return m_codeBase + ConfigExtension;
        }
    }
}
